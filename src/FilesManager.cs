...
namespace FroalaEditor
{
    ...
    public static class FilesManager
    {
        ...
        /// <summary>
        /// FilesManager default options.
        /// </summary>
        public static FilesManagerOptions defaultOptions = new FilesManagerOptions();
        ...
        /// <param name="options">FilesManager options.</param>
        /// <returns>Object with link.</returns>
        public static object Upload(HttpContext httpContext, string fileRoute, FilesManagerOptions options = null)
        {
        ...
        public static void Save(Stream fileStream, string filePath, FilesManagerOptions options)
        {
            if (options is FilesManagerOptions && ((FilesManagerOptions)options).ResizeGeometry != null)
            {
                // Resize file and save it..
                MagickImage image = new MagickImage(fileStream);
                image.Resize(((FilesManagerOptions)options).ResizeGeometry);
